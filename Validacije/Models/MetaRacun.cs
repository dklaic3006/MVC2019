...
{
    [NeViseOdTriDana(ErrorMessage ="Datum ne smije biti mani za više od tri dana!")]

    public class MetaRacun
    {
        [Required(ErrorMessage ="Broj računa je obavezan!")]
        [StringLength(10, MinimumLength =3, ErrorMessage ="Duljina racuna mora biti između 3 i 10 znakova!")]
